    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <center>
                    <form class="form" action="signup.php" method="POST" id="signUpForm">
        ...
        ?>
                        ...
                        <button class="submit" type="submit" href="login.php">Submit</button>
                        <p class="signin">Already have an account? <a href="sign-in.php" c>Signin</a></p>
                    </form>
                </center>
            </div>
        </div>
